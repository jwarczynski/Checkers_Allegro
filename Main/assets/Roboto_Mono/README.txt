...
Roboto Mono is a variable coordinateFont with this axis:
  wght
...
in those cases you can use the static coordinateFont files for Roboto Mono:
...
1. Install the coordinateFont files you want to use

2. Use your app's coordinateFont picker to view the coordinateFont family and all the
available styles
...
Installing fonts
  ...
  Linux: https://www.google.com/search?q=how+to+install+a+coordinateFont+on+gnu%2Blinux
  Windows: https://support.microsoft.com/en-us/help/314960/how-to-install-or-remove-a-coordinateFont-in-windows
